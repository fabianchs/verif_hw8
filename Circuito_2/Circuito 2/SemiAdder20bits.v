...
module SemiAdder20bits(A,B,R);
	input [19:0] A,B;
	output [19:0] R;
	
	wire C0,C1,C2,C4,C5,C6,C7,C8,C9,C10,C11,C12,C13,C14,C15,C16,C17,C18;
	...
	FullAdder	AD15 (A[15],B[15],C14,R[15],C15);				
	FullAdder	AD16 (A[16],B[16],C15,R[16],C16);
	FullAdder	AD17 (A[17],B[17],C16,R[17],C17);
	FullAdder	AD18 (A[18],B[18],C17,R[18],C18);
	SemiAdderFin	AD19 (A[19],B[19],C18,R[19]);
